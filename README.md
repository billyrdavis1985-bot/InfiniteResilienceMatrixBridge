...
![IRMB Banner](https://raw.githubusercontent.com/billyrdavis1985-bot/IRMB/main/banner.png)
...
┌─────────────────────────────────────────────────────────────┐
│                   ADAPTIVE CONTROLLER                        │
│  • Learns optimal configs from 25+ missions                  │
│  • Exploration: 20% → 12.1% (auto-decay)                     │
